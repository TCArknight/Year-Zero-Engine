...
-->
  ...
  <!-- color used to identify neutral actors on the tactical console -->
  <resource
    id="clrneutral">
    <color
      color="a0e0ff">
...
<!-- ##### Styles - Checkboxes ##### -->
  ...
  <!-- checkbox style for display of attribute damage -->
  <style
    id="chkAttrDmg">
    <style_checkbox
      textcolorid="clrnormal"
      font="fntcheck"
      check="chkdmgsel"
      checkoff="chkdmgseloff"
      uncheck="chkempty"
      uncheckoff="chkemptyoff">
      </style_checkbox>
    <resource
      id="chkdmgsel"
      isbuiltin="no">
      <bitmap
        bitmap="check_dmg_select.bmp">
        </bitmap>
      </resource>
    <resource
      id="chkdmgseloff"
      isbuiltin="no">
      <bitmap
        bitmap="check_dmg_select_off.bmp">
        </bitmap>
      </resource>
    <resource
      id="chkempty"
